...
<template>
    <li
        class="mb-8 flex flex-col justify-between gap-8 border-b border-b-border-accented pb-8 first-of-type:mt-16 last-of-type:border-none sm:flex-row sm:items-center"
    >
        <div>
