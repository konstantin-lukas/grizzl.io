...
<template>
    <div
        class="relative mx-auto -mt-4 flex max-w-150 justify-center overflow-hidden pt-4 before:pointer-events-none before:absolute before:top-0 before:left-0 before:z-1 before:h-full before:w-12 before:bg-linear-to-l before:from-back/0 before:to-back before:content-[''] after:pointer-events-none after:absolute after:top-0 after:right-0 after:h-full after:w-12 after:bg-linear-to-r after:from-back/0 after:to-back after:content-['']"
    >
        <div
            class="flex"
